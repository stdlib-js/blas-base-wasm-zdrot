...
```javascript
zdrot = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-zdrot@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-wasm-zdrot@v0.1.1-umd/browser.js"></script>
```
